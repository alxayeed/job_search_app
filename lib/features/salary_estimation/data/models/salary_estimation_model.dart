...
class SalaryEstimationModel extends SalaryEstimationEntity {
  ...
  factory SalaryEstimationModel.fromJson(Map<String, dynamic> json) {
    return SalaryEstimationModel(
      ...
      minimumSalary:
          json["min_salary"] != null ? json["min_salary"].toDouble() : null,
      maximumSalary:
          json["max_salary"] != null ? json["max_salary"].toDouble() : null,
      medianSalary: json["median_salary"] != null
          ? json["median_salary"].toDouble()
          : null,
